package good.job.pj.common.aspect;
...
import good.job.pj.common.util.IPUtils;
...
public class SysLogAspect {
	...
	@Pointcut("@annotation(good.job.pj.common.annotation.RequiredLog)")
